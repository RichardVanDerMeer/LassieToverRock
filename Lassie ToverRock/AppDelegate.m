...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	ProgrammaViewController *programmaViewController = [[ProgrammaViewController alloc] init];
	UINavigationController *programmaNavigationController = [[UINavigationController alloc] initWithRootViewController:programmaViewController];
	
	PicturesViewController *picturesViewController = [[PicturesViewController alloc] init];
	UINavigationController *picturesNavigationController = [[UINavigationController alloc] initWithRootViewController:picturesViewController];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Lassie_ToverRock" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Lassie_ToverRock.sqlite"];
